...
public class InicializadorCartas {    
    ...
    private void inicializarCartas(){
        ...
        cartas.add(new Carta("Você tirou o primeiro lugar no campenonato de vôlei. Parabéns receba 100!", new Recebe(100)));
        cartas.add(new Carta("Você apostou com suas parceiras deste jogo e ganhou, receba 50 de cada uma.", new Aposta()));        
