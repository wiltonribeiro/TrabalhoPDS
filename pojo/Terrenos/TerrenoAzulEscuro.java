...
public class TerrenoAzulEscuro extends Terreno {
    ...
    public TerrenoAzulEscuro(String nome, int preco, int aluguel, int umaCasa, int duasCasas, int tresCasas, int quatroCasas, int hotel, int x, int y, int construirCasa) {
